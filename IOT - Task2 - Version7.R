...
plot(fcGAParima, main = "GAP 2011 Forecast By Month With Arima Model")

tsSM0arima <- auto.arima(tsbymonthSM0)
fcSM0arima <- forecast(tsSM0arima, h = 12)
plot(fcSM0arima, main = "SM0 2011 Forecast By Month With Arima Model")

tsSM1arima <- auto.arima(tsbymonthSM1)
fcSM1arima <- forecast(tsSM1arima, h = 12)
plot(fcSM1arima, main = "Kitchen 2011 Forecast By Month With Arima Model")

tsSM2arima <- auto.arima(tsbymonthSM2)
fcSM2arima <- forecast(tsSM2arima, h = 12)
plot(fcSM2arima, main = "Laundry 2011 Forecast By Month With Arima Model")

tsSM3arima <- auto.arima(tsbymonthSM3)
fcSM3arima <- forecast(tsSM3arima, h = 12)
plot(fcSM3arima, main = "Heater 2011 Forecast By Month With Arima Model")
...
seasonalnaiveGAP1 <- snaive(tsbymonthGAP, h = 12)
seasonalnaiveGAP2 <- snaive(tsbymonthGAPAdjusted, h = 12)
plot(seasonalnaiveGAP1, 
     main = "Global Active Power Forecast Seasonal Naive Method")
plot(seasonalnaiveGAP2,
     main = "Global Active Power Forecast Seasonal Naive Method")
...
tstrainsetGAP <- ts(rdytrainset$meanGAP, start = c(2007), frequency = 12)
tstestsetGAP <- ts(rdytestset$meanGAP, start = c(2010), frequency = 12)

# Linear Model Forecast
tstrainGAPlm <- tslm(tstrainsetGAP~season + trend, tstrainsetGAP)
fctrainGAPlm <- forecast(tstrainGAPlm, h = 12)
plot(fctrainGAPlm, main = "Global Active Power 2010 Forecast With Linear Model")
lines(tstestsetGAP, col = "red", lwd = 2)

# Arima Model Forecast
tstrainGAParima <- auto.arima(tstrainsetGAP)
fctrainGAParima <- forecast(tstrainGAParima, h = 12)
plot(fctrainGAParima, main = "Global Active Power 2010 Forecast With Arima Model", cex.main = 2)
lines(tstestsetGAP, col = "red", lwd = 2)

# HoltWinters Model Forecast
tstrainGAPhw <- HoltWinters(tstrainsetGAP)
fctrainGAPhw <- forecast(tstrainGAPhw, h = 12)
plot(fctrainGAPhw, main = "Global Active Power 2010 Forecast With HoltWinters", cex.main = 2)
lines(tstestsetGAP, col = "red", lwd = 2)

## Analyzing Kitchen Predictions

# Time Series Creation For Train And Test Sets 
tstrainsetSM1 <- ts(rdytrainset$meanSM1, start = c(2007), frequency = 12)
tstestsetSM1 <- ts(rdytestset$meanSM1, start = c(2010), frequency = 12)

# Linear Model Forecast
tstrainSM1lm <- tslm(tstrainsetSM1~season + trend, tstrainsetSM1)
fctrainSM1lm <- forecast(tstrainSM1lm, h = 12)
plot(fctrainSM1lm, main = "Kitchen 2010 Forecast With Linear Model")
lines(tstestsetSM1, col = "red", lwd = 2)
summary(tstrainSM1lm)

# Arima Model Forecast
tstrainSM1arima <- auto.arima(tstrainsetSM1)
fctrainSM1arima <- forecast(tstrainSM1arima, h = 12)
plot(fctrainSM1arima, main = "Kitchen 2010 Forecast With Arima Model", cex.main = 2)
lines(tstestsetSM1, col = "red", lwd = 2)
...
plot(fctrainSM1hw, main = "KItchen 2010 Forecast With HoltWinters", cex.main = 2)
lines(tstestsetSM1, col = "red", lwd = 2)

## Analyzing Laundry Predictions

# Time Series Creation For Train And Test Sets 
tstrainsetSM2 <- ts(rdytrainset$meanSM2, start = c(2007), frequency = 12)
tstestsetSM2 <- ts(rdytestset$meanSM2, start = c(2010), frequency = 12)

# Linear Model Forecast
tstrainSM2lm <- tslm(tstrainsetSM2~season + trend, tstrainsetSM2)
fctrainSM2lm <- forecast(tstrainSM2lm, h = 12)
plot(fctrainSM2lm, main = "Laundry 2010 Forecast With Linear Model")
lines(tstestsetSM2, col = "red", lwd = 2)
summary(tstrainSM2lm)

# Arima Model Forecast
tstrainSM2arima <- auto.arima(tstrainsetSM2)
fctrainSM2arima <- forecast(tstrainSM2arima, h = 12)
plot(fctrainSM2arima, main = "Laundry 2010 Forecast With Arima Model", cex.main = 2)
lines(tstestsetSM2, col = "red", lwd = 2)
...
plot(fctrainSM2hw, main = "Laundry 2010 Forecast With HoltWinters", cex.main = 2)
lines(tstestsetSM2, col = "red", lwd = 2)

## Analyzing Heater & AC Predictions

# Time Series Creation For Train And Test Sets 
tstrainsetSM3 <- ts(rdytrainset$meanSM3, start = c(2007), frequency = 12)
tstestsetSM3 <- ts(rdytestset$meanSM3, start = c(2010), frequency = 12)

# Linear Model Forecast
tstrainSM3lm <- tslm(tstrainsetSM3~season + trend, tstrainsetSM3)
fctrainSM3lm <- forecast(tstrainSM3lm, h = 12)
plot(fctrainSM3lm, main = "Heater & AC 2010 Forecast With Linear Model")
lines(tstestsetSM3, col = "red", lwd = 2)
summary(tstrainSM3lm)

# Arima Model Forecast
tstrainSM3arima <- auto.arima(tstrainsetSM3)
fctrainSM3arima <- forecast(tstrainSM3arima, h = 12)
plot(fctrainSM3arima, main = "Heater & AC 2010 Forecast With Arima Model", cex.main = 2)
lines(tstestsetSM3, col = "red", lwd = 2)
...
plot(fctrainSM3hw, main = "Heater & AC 2010 Forecast With HoltWinters", cex.main = 2)
lines(tstestsetSM3, col = "red", lwd = 2)